...
function AuctionStep2({
  ...
  const [address, SetAddress] = useState(bkp.address);
  ...
  function checkConditions() {
    const addressNotEnough = address.length < 1;
    
    SetDisabled(addressNotEnough);
  }
