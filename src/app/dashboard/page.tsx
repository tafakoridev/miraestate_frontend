...
const DashobardPage = () => {
  ...
  return (
    <div className="w-full h-full flex flex-row">
      <div
        className={`easy-animation h-full ${
          open ? "md:w-1/6 w-full md:static fixed" : " md:w-0 w-0 "
        }`}
      >
        <Sidebar SetOpen={SetOpen} open={open} />
      </div>
      <div
        className={`easy-animation md:w-5/6 flex flex-col justify-between w-full ${
          open ? "md:w-5/6" : "md:w-full"
        }`}
      >
