        ...
        GetUser().then(async (user) => {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    Notify.success('مناقصه با موفقیت ایجاد شد');
                } else {
                    ...
                    <label>
                        <textarea
                            ...
                            className="
                                ...
                                focus:outline-none
                                "
                            placeholder="توضیحات مناقصه را اینجا وارد کنید..."></textarea>

                    </label>
                </div>
                <div>
                    <button className="my-2 float-left text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2" type="submit">ایجاد مناقصه</button>
                </div>
            </form>
        </div>
    );
